...
![일반 추천 및 유저 선호태그와 유사도가 높은 공연 추천](README.assets/일반_추천_및_유저_선호태그_유사도가_높은_공연_추천.gif)
...
![피어슨 상관계수](README.assets/피어슨_상관계수-164937506012322.png)

![피어슨 상관계수_수식](README.assets/피어슨_상관계수_수식.png)
